 ...
 */
    ...
    */
    ...
    async send2ButtonTamplate(jid, buffer, content, footer, kontak, nomer, footer, namelink2, link2, button1, row1, button2, row2, quoted, options = {}) {
      return await this.sendMessage(jid, {
        locationMessage: { jpegThumbnail: buffer },
        ContentText: content,
        FooterText: footer,
        Buttons: [
          { callButton: {displayText: kontak, phoneNumber: link1 } },
          { urlButton: { displayText: namelink2, url : link2 } },
          { quickReplyButton: { displayText: button1, id: row1 } },
          { quickReplyButton: { displayText: button2, id: row2 } }
        ],
        headerType: 6
      }, MessageType.buttonsMessage, { quoted, ...options })
    }
